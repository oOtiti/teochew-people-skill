...
8. 输出时区分 verified、attributed statement、frame observation、synthesis、varies、unknown，并给出来源、时间码、权利状态与核验日期。
...
范围明确、首轮不超过 3 页、关键事实可追溯、地方差异保留、当前信息已实时核验、生产细节没有编造；媒体输出还必须能回到原页面与时间码，并且不复制 `link_only` 内容。
